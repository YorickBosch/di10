...
%>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p><a href="<%=StandardPage.HOE%>" class="btn btn-primary btn-lg" role="button">Meer weten? &raquo;</a></p>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 col-lg-4">
          ...
          <p><a class="btn btn-default" href="<%=StandardPage.HOE%>" role="button">Meer informatie &raquo;</a></p>
        </div>
        <div class="col-sm-6 col-md-4 col-lg-4">
          <h2>Voor u</h2>
