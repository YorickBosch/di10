...
<body>
	...
	<div class="jumbotron">
		<div class="container">
			...
			<p>Concordia's kunstverhuur is vergelijkbaar met een bibliotheek.
				Met een jaarabonnement kun je om het half jaar een nieuw werk uit de
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 col-md-4 col-lg-4">
				<h2>Voor jou</h2>
				<p>Altijd al een uniek schilderij willen hebben? Dat kan! Voor
					slechts € 7,50 per maand huur je een uniek en origineel kunstwerk
					bij Concordia. Ben je er op uitgekeken, dan kies je iets nieuws uit
			...
			<div class="col-sm-6 col-md-4 col-lg-4">
				<h2>Voor u</h2>
				<p>De bedrijvencollectie onderscheidt zich door groter en vaak
					seriematig werk, uitstekend geschikt voor ontvangst- en
					vergaderruimten. De kunstwerken geven een meerwaarde aan uw
			...
			<div class="col-sm-6 col-md-4 col-lg-4">
				...
				<p>Laat een groot publiek kennis maken met jouw kunst. Verhuur
					je werk via Concordia's kunstverhuur. Concordia is altijd op zoek
